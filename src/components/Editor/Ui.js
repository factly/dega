...
export default class Ui {
  ...
  //   }
     ...
     * @returns {void}
     */
    applyTune(tuneName, status, wrapper) {
        console.log('tuneName in Ui',tuneName,'status',status);
      this.nodes.wrapper.classList.toggle(`${this.CSS.wrapper}--${tuneName}`, status);
      //wrapper.classList.toggle(`${this.CSS.wrapper}--${tuneName}`, status);
  
      console.log('this.nodes.wrapper.classList ',this.nodes.wrapper.classList);
    }
  }
