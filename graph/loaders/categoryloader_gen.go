...
type CategoryLoaderConfig struct {
	...
	Fetch func(keys []string) ([]*models.Category, []error)
...
func (l *CategoryLoader) Load(key string) (*models.Category, error) {
...
func (l *CategoryLoader) LoadThunk(key string) func() (*models.Category, error) {
	l.mu.Lock()
...
func (l *CategoryLoader) LoadAll(keys []string) ([]*models.Category, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *CategoryLoader) LoadAllThunk(keys []string) func() ([]*models.Category, []error) {
	results := make([]func() (*models.Category, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *CategoryLoader) Prime(key string, value *models.Category) bool {
	l.mu.Lock()
	var found bool
...
func (l *CategoryLoader) unsafeSet(key string, value *models.Category) {
	if l.cache == nil {
		l.cache = map[string]*models.Category{}
	}
	l.cache[key] = value
}
...
func (b *categoryLoaderBatch) keyIndex(l *CategoryLoader, key string) int {
