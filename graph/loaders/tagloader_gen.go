...
type TagLoaderConfig struct {
	...
	Fetch func(keys []string) ([]*models.Tag, []error)
...
func (l *TagLoader) Load(key string) (*models.Tag, error) {
...
func (l *TagLoader) LoadThunk(key string) func() (*models.Tag, error) {
	l.mu.Lock()
...
func (l *TagLoader) LoadAll(keys []string) ([]*models.Tag, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *TagLoader) LoadAllThunk(keys []string) func() ([]*models.Tag, []error) {
	results := make([]func() (*models.Tag, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *TagLoader) Prime(key string, value *models.Tag) bool {
	l.mu.Lock()
	var found bool
...
func (l *TagLoader) Clear(key string) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *TagLoader) unsafeSet(key string, value *models.Tag) {
	if l.cache == nil {
		l.cache = map[string]*models.Tag{}
	}
	l.cache[key] = value
}
...
func (b *tagLoaderBatch) keyIndex(l *TagLoader, key string) int {
