interface Stats {
  humanlanguage?: Record<string, any>;
  "publisher.site"?: Record<string, any>;
  publishercountry?: Record<string, any>;
  [key: string]: any;
}

export function getResultStringFromStats(stats: Stats, total: number): string {
  var languageCount = 0;
