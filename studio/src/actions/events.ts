...
export const addDefaultEvents = (query: any) => {
  return (dispatch: (action: any) => void) => {
    ...
    return axios
      ...
      .then((response) => {
        ...
        dispatch(
          addEventsRequest({
            data: response.data.nodes.map((item: Event) => item.id),
            query: query,
...
export const loadingEvents = (): EventAction => ({
  type: SET_EVENTS_LOADING,
  payload: true,
});

export const stopEventsLoading = (): EventAction => ({
  type: SET_EVENTS_LOADING,
  payload: false,
});

export const addEvent = (type: string, payload: Event): EventAction => ({
  type,
  payload,
});

export const addEvents = (payload: Event[]): EventAction => ({
  type: ADD_EVENTS,
  payload,
});

export const addEventsRequest = (payload: EventRequestData): EventAction => ({
