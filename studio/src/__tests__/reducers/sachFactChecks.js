import reducer from '../../reducers/sachFactChecksReducer';
...
describe('sach fact check reducer', () => {
  // testing for the initial state
  it('should return the initial state', () => {
    expect(reducer(undefined, {})).toEqual(initialState);
  });

  // testing when no action is passed -  it should return the previous state
  ...
  // testing SET_SACH_FACT_CHECKS_LOADING case
  it('should handle SET_SACH_FACT_CHECKS_LOADING', () => {
    expect(
  ...
  // testing ADD_SACH_FACT_CHECKS case
  it('should handle ADD_SACH_FACT_CHECKS', () => {
    expect(
      reducer(initialState, {
