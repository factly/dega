...
describe('Website Edit Form component', () => {
  store = mockStore({
    spaces: {
  ...
  describe('snapshot testing', () => {
    ...
    it('should render the component with props', () => {
      const tree = mount(
        <Provider store={store}>
          <WebsiteEditForm onCreate={onCreate} />
        </Provider>,
      );
      expect(tree).toMatchSnapshot();
    });
  ...
  describe('component testing', () => {
    ...
    it('should submit form with added data', (done) => {
      ...
      act(() => {
        wrapper = mount(
          <Provider store={store}>
            <WebsiteEditForm data={data2} onCreate={props.onCreate} />
          </Provider>,
        );
      });
      act(() => {
      ...
      act(() => {
        ...
        wrapper
          ...
          .at(0)
          .props()
          .onChange({ target: { value: '{"sample":"testing2"}' } });
