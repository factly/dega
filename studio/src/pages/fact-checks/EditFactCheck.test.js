...
import EditFactCheck from './EditFactCheck';
import * as actions from '../../actions/posts';
import FactCheckEditForm from './components/FactCheckForm';
...
describe('FactCheck edit component', () => {
  ...
  describe('component testing', () => {
    ...
    it('should call updatePost', (done) => {
      ...
      wrapper.find(FactCheckEditForm).props().onCreate({ status: 'draft' });
      setTimeout(() => {
