...
func Migration() {
	...
	config.DB.Model(&Claimant{}).AddForeignKey("space_id", "spaces(id)", "RESTRICT", "RESTRICT")
	config.DB.Model(&Rating{}).AddForeignKey("medium_id", "media(id)", "RESTRICT", "RESTRICT")
	config.DB.Model(&Rating{}).AddForeignKey("space_id", "spaces(id)", "RESTRICT", "RESTRICT")
	...
	config.DB.Model(&Claim{}).AddForeignKey("space_id", "spaces(id)", "RESTRICT", "RESTRICT")
