...
type Space struct {
	...
	LogoID            uint           `gorm:"column:logo_id" json:"logo_id"`
	LogoMobileID      uint           `gorm:"column:logo_mobile_id" json:"logo_mobile_id"`
	FavIconID         uint           `gorm:"column:fav_icon_id" json:"fav_icon_id"`
	MobileIconID      uint           `gorm:"column:mobile_icon_id" json:"mobile_icon_id"`
